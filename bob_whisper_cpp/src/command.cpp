...
rclcpp::Publisher<std_msgs::msg::String>::SharedPtr g_pub_command;

static void publish_command(const std::string & command)
{
    std_msgs::msg::String msg;
    msg.data = command;
    g_pub_command->publish(msg);
}
        ...
        if (::vad_simple(pcmf32_cur, WHISPER_SAMPLE_RATE, 1000, params.vad_thold, params.freq_thold, params.print_energy)) {
            ...
            // NOTE: not optimal
            {
                ...
                // best command
                {
                    ...
                    publish_command(allowed_commands[index]);
...
int main(int argc, char ** argv)
{
    ...
    g_node        = rclcpp::Node::make_shared("command");
    g_pub_command = g_node->create_publisher<std_msgs::msg::String>("command", 10);
